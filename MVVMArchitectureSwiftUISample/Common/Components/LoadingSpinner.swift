...
struct LoadingSpinner: View {
    ...
    var body: some View {
        ZStack {
            ...
            ZStack {
                // S3
                SpinnerCircle(start: spinnerStart, end: spinnerEndS2S3, rotation: rotationDegreeS3, color: CustomColor.darkViolet)

                // S2
                SpinnerCircle(start: spinnerStart, end: spinnerEndS2S3, rotation: rotationDegreeS2, color: CustomColor.darkPink)

                // S1
                SpinnerCircle(start: spinnerStart, end: spinnerEndS1, rotation: rotationDegreeS1, color: CustomColor.darkBlue)
